...
[assembly:
    SuppressMessage(
        ...
        Scope = "member",
        Target = "~P:IdentityServer.TestUsers.Users")]
[assembly:
    SuppressMessage(
        "Design",
        ...
        Scope = "type",
        Target = "~T:IdentityServer.Pages.Login.ViewModel.ExternalProvider")]
[assembly:
    SuppressMessage(
        "Naming",
        ...
        Scope = "namespace",
        Target = "~N:IdentityServer.Pages.Error")]
[assembly:
    SuppressMessage(
        "Naming",
        ...
        Scope = "type",
        Target = "~T:IdentityServer.Pages.Ciba.Consent")]
[assembly:
    SuppressMessage(
        "Naming",
        "CA1724:Type names should not match namespaces",
        Justification =
            "Namespaces of pages are not likely to be used elsewhere, so there is little chance of confusion",
        Scope = "type",
        Target = "~T:IdentityServer.Pages.Extensions")]
[assembly:
    SuppressMessage(
        "Performance",
        ...
        Scope = "member",
        Target = "~F:IdentityServer.Pages.Logout.LogoutOptions.AutomaticRedirectAfterSignOut")]
