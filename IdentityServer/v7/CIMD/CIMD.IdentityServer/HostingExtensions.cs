...
internal static class HostingExtensions
{
        ...
        this IIdentityServerBuilder builder) where T : class, IClientStore
    {
        ...
        builder.Services.AddHttpClient(CimdDocumentFetcher.HttpClientName, client =>
            ...
            .ConfigurePrimaryHttpMessageHandler(sp =>
            {
                ...
                if (env.IsDevelopment() && ServerIsOnLoopback(sp))
                {
    ...
    /// the server itself is running on a loopback address.
    /// </summary>
    private static bool ServerIsOnLoopback(IServiceProvider sp)
    {
