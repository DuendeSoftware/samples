...
namespace IdentityServerHost.Migrations.ConfigurationDb
{
    ...
    [Migration("20260410081252_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProvider", b =>
                {
                    ...
                    b.Property<int>("AssertionConsumerServiceBinding")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("ClockSkewTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DefaultPersistentNameIdentifierClaimType")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long?>("RequestMaxAgeTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("SingleLogoutServiceBinding")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProviderAssertionConsumerService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SamlServiceProviderId", "Url")
                        .IsUnique();

                    b.ToTable("SamlServiceProviderAssertionConsumerServices", (string)null);
                });

            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProviderClaimMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SamlServiceProviderClaimMappings", (string)null);
                });

            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProviderEncryptionCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SamlServiceProviderEncryptionCertificates", (string)null);
                });

            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProviderSigningCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SamlServiceProviderSigningCertificates", (string)null);
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProviderEncryptionCertificate", b =>
                {
                    b.HasOne("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProvider", "SamlServiceProvider")
                        .WithMany("EncryptionCertificates")
                        .HasForeignKey("SamlServiceProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlServiceProvider", b =>
                {
                    ...
                    b.Navigation("EncryptionCertificates");
