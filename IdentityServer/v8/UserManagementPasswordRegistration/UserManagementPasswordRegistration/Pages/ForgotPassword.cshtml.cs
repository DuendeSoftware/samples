...
public class ForgotPasswordModel(IOtpSender otpSender, OtpCookie otpCookie) : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        switch (result)
        {
            case SendOtpResult.Sent sentResult:
                ...
                return RedirectToPage("/CompleteForgotPassword", new { ReturnUrl = Url.IsLocalUrl(ReturnUrl) ? ReturnUrl : Url.Content("~/") });
