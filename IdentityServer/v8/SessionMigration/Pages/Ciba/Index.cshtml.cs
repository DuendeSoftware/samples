...
namespace SessionMigration.Pages.Ciba;
...
public class IndexModel : PageModel
{
    ...
    {
        LoginRequest = await _backchannelAuthenticationInteraction.GetLoginRequestByInternalIdAsync(id, HttpContext.RequestAborted);
