...
3. SimpleApi - A simple API, shared across all examples, that authenticates requests using bearer tokens signed by IdentityServer
4. ConsoleDcrClient - A console application that registers a client application


## Running the solution

The Configuration examples use an IdentityServer host which is shared by all configuration examples.
...
Then, run the IdentityServer, Configuration, and SimpleApi projects which are all included in the solution.
