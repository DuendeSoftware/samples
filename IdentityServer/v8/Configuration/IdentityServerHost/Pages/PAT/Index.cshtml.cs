...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        {
            Issuer = await _issuerNameService.GetCurrentAsync(HttpContext.RequestAborted),
        ...
        Token = await _tokenService.CreateSecurityTokenAsync(token, HttpContext.RequestAborted);
        return Page();
    }
}
